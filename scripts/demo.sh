...
echo ""
echo "  ╔══════════════════════════════════════════════════╗"
echo "  ║  2. MÓDULOS DISPONIBLES (22 MÓDULOS)  ║"
echo "  ╚══════════════════════════════════════════════════╝"
echo ""
...
echo "  ─────────────────────────────────────────────"
echo "   ⚔️  16 módulos de ataque Bluetooth"
echo "   💥 3  módulos de exploit avanzado"
echo "   🔵 3  escáneres (dispositivos, servicios y vulnerabilidades)"
...
echo "   │   ├── modules/      → 22 módulos total"
echo "   │   │   ├── attacks/  → 14 ataques BT"
echo "   │   │   ├── scanners/ → 3 escáneres"
echo "   │   │   └── exploits/ → 3 exploits"
echo "   │   └── utils/        → Utilidades"
echo "   ├── tests/            → 290+ tests offline"
